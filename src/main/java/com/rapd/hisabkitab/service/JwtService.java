...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return generateToken(propertiesMapper.generateMapFromObject(userDetails), userDetails);
    }
    ...
    private String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, Long jwtExpirationTime) {
        return Jwts.builder()
                   ...
                   .setExpiration(Date.from(java.time.Instant.now().plusMillis(jwtExpirationTime)))
    ...
    private Key getSignInKey() {
        byte[] keyBytes = Decoders.BASE64.decode(applicationStartup.getEnvironmentVariable("jwt_secret"));
